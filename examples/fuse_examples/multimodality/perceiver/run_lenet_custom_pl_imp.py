...
def run_train(paths: dict, train_params: dict):
    ...
    lightning_csv_logger = CSVLogger(save_dir=paths["model_dir"]+"/lightning_logs/", name="lightning_csv_logs_lenet")
    lightning_tb_logger = TensorBoardLogger(save_dir=paths["model_dir"]+"/lightning_logs/", name="lightning_tb_logs_lenet")
    print("Fuse Train")
