...
if (num_nodes > 1) or (num_devices > 1):
    ...
    # command_to_run=f'pyutils-run /u/shatz/repos/fuse-med-ml/examples/fuse_examples/imaging/classification/mnist/ddp_example/simple_mnist_starter_ddp.py --num_nodes={num_nodes} --num_devices={num_devices} --lr={lr}',
