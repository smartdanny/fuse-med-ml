...
if __name__ == "__main__":
    ...
    # if args.num_nodes or args.num_devices:
    #     if (int(os.environ["NODE_RANK"]) == 0) & (int(os.environ["LOCAL_RANK"]) == 0):
    #         task = Task.init(project_name="shatz_root/shatz_ddp_knight_0", task_name=f"num_nodes={args.num_nodes} num_gpus={args.num_devices}")
